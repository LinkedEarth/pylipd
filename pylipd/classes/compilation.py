...
class Compilation:
    """PyLiPD representation of the `Compilation` concept from the LinkedEarth ontology.
    ...
    def __init__(self):
        """Instantiate a blank \`Compilation\` object with a freshly minted identifier.
    ...
    def from_data(id, data) -> 'Compilation':
        """Create a `Compilation` instance from a JSON-LD data dictionary produced by
        :py:meth:`to_data`.
    ...
    def from_json(data) -> 'Compilation':
        """Re-instantiate a `Compilation` from the lightweight JSON produced by
        :py:meth:`to_json`.
