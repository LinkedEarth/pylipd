...
class Calibration:
    """PyLiPD representation of the `Calibration` concept from the LinkedEarth ontology.
    ...
    def __init__(self):
        """Instantiate a blank \`Calibration\` object with a freshly minted identifier.
    ...
    def from_data(id, data) -> 'Calibration':
        """Create a `Calibration` instance from a JSON-LD data dictionary produced by
        :py:meth:`to_data`.
    ...
    def from_json(data) -> 'Calibration':
        """Re-instantiate a `Calibration` from the lightweight JSON produced by
        :py:meth:`to_json`.
