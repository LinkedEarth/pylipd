...
class Dataset:
    """PyLiPD representation of the `Dataset` concept from the LinkedEarth ontology.
    ...
    def __init__(self):
        """Instantiate a blank \`Dataset\` object with a freshly minted identifier.
    ...
    def from_data(id, data) -> 'Dataset':
        """Create a `Dataset` instance from a JSON-LD data dictionary produced by
        :py:meth:`to_data`.
    ...
    def from_json(data) -> 'Dataset':
        """Re-instantiate a `Dataset` from the lightweight JSON produced by
        :py:meth:`to_json`.
