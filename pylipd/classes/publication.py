...
class Publication:
    """PyLiPD representation of the `Publication` concept from the LinkedEarth ontology.
    ...
    def __init__(self):
        """Instantiate a blank \`Publication\` object with a freshly minted identifier.
    ...
    def from_data(id, data) -> 'Publication':
        """Create a `Publication` instance from a JSON-LD data dictionary produced by
        :py:meth:`to_data`.
    ...
    def from_json(data) -> 'Publication':
        """Re-instantiate a `Publication` from the lightweight JSON produced by
        :py:meth:`to_json`.
