...
class Interpretation:
    """PyLiPD representation of the `Interpretation` concept from the LinkedEarth ontology.
    ...
    def __init__(self):
        """Instantiate a blank \`Interpretation\` object with a freshly minted identifier.
    ...
    def from_data(id, data) -> 'Interpretation':
        """Create a `Interpretation` instance from a JSON-LD data dictionary produced by
        :py:meth:`to_data`.
    ...
    def from_json(data) -> 'Interpretation':
        """Re-instantiate a `Interpretation` from the lightweight JSON produced by
        :py:meth:`to_json`.
