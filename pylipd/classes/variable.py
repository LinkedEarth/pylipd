...
class Variable:
    """PyLiPD representation of the `Variable` concept from the LinkedEarth ontology.
    ...
    def __init__(self):
        """Instantiate a blank \`Variable\` object with a freshly minted identifier.
    ...
    def from_data(id, data) -> 'Variable':
        """Create a `Variable` instance from a JSON-LD data dictionary produced by
        :py:meth:`to_data`.
    ...
    def from_json(data) -> 'Variable':
        """Re-instantiate a `Variable` from the lightweight JSON produced by
        :py:meth:`to_json`.
