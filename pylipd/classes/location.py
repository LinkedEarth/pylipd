...
class Location:
    """PyLiPD representation of the `Location` concept from the LinkedEarth ontology.
    ...
    def __init__(self):
        """Instantiate a blank \`Location\` object with a freshly minted identifier.
    ...
    def from_data(id, data) -> 'Location':
        """Create a `Location` instance from a JSON-LD data dictionary produced by
        :py:meth:`to_data`.
    ...
    def from_json(data) -> 'Location':
        """Re-instantiate a `Location` from the lightweight JSON produced by
        :py:meth:`to_json`.
